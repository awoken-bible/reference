...
describe("Geometry", () => {
  ...
  it('indexOf and verseAtIndex', () => {
	...
	it('Large List Performance', () => {
		// all verses which mention "Jesus"
		...
		// filter to only bible chapters which intersect verse list...
		//
		// Under old nieve implementation this calls intersects ~1000 times
		// and takes ~550ms
		//
		// precomputed version and with optimized implementation of intersects
		// which doesn't just internally call getIntersection this is down to ~15ms
