...
describe("parse", () => {
	...
	it("URL", () => {
		...
		// ranges after v make a verse range
		run('gen3v2-4', [
			{ is_range: true,
		...
		// _ can split groups, and we can have a range between two exact verses
		...
		// test for consistancy between parse and parseUrlEncode
